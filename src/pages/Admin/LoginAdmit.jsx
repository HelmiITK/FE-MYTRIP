...
import { loginAdmit } from "../redux/Actions/AuthActions";
...
const LoginAdmit = () => {
  ...
  const handleLogin = (e) => {
    ...
    dispatch(loginAdmit(email, password, navigate));
  };
      ...
      <div className="flex min-h-screen">
        <div className="w-[100%] lg:w-[50%] flex flex-col justify-center items-center mx-[23px] lg:px-[145px] ">
          <form onSubmit={handleLogin} className="w-full">
            <h1 className="text-[24px] font-bold text-darkblue mb-8">Login Admin-Mitra</h1>
